...
<p style="font-family:Arial;" align="center" class="style2"><strong>List Tanggal Order Pembelian</strong></p><center>

<div align="center">
  <table width="450" border="1" bgcolor="#FFFF0F">
    <tr>
      <td width="100"><div align="center" class="style3"><strong>Serial</strong></div></td>
      <td width="100"><div align="center" class="style3"><strong>Date</strong></div></td>
      <td width="100"><div align="center" class="style3"><strong>Customer Id</strong></div></td>
    </tr>
  ...
  ?>
    <tr>
      ...
      <td><div align="center" class="style3"><?php echo $kolom[2];?></div></td>
	  <?php }?>
    </tr>
  </table>
</div>
