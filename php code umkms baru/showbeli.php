...
<p style="font-family:Arial;" align="center" class="style2"><strong>List Pembeli</strong></p><center>

<div align="center">
  <table width="450" border="1" bgcolor="#FFFF0F">
    <tr>
      <td width="100"><div align="center" class="style3"><strong>Serial</strong></div></td>
      <td width="100"><div align="center" class="style3"><strong>Name</strong></div></td>
      <td width="100"><div align="center" class="style3"><strong>Email</strong></div></td>
	  <td width="100"><div align="center" class="style3"><strong>Address</strong></div></td>
	  <td width="100"><div align="center" class="style3"><strong>Phone</strong></div></td>
    </tr>
	<?php while($kolom=mysql_fetch_array($sql)){
  ?>
    <tr>
      <td><span class="style3"><?php echo $kolom[0];?></span></td>
      <td><span class="style3"><?php echo $kolom[1];?></span></td>
	  <td><span class="style3"><?php echo $kolom[2];?></span></td>
	  <td><span class="style3"><?php echo $kolom[3];?></span></td>
      <td><div align="center" class="style3"><?php echo $kolom[4];?></div></td>
	  <?php }?>
    </tr>
  </table>
</div>
