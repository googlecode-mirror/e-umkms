...
<p>
  <?php
	include 'connect.php';
	$sql=mysql_query("select * from order_detail");
?>
</p>
<p style="font-family:Arial;" align="center" class="style2"><strong>List Detail Pembelian</strong></p><center>

<div align="center">
  <table width="450" border="1" bgcolor="#FFFF0F">
    <tr>
      <td width="100"><div align="center" class="style3"><strong>Orderid</strong></div></td>
      <td width="100"><div align="center" class="style3"><strong>Productid</strong></div></td>
      <td width="100"><div align="center" class="style3"><strong>Quantity</strong></div></td>
	  <td width="100"><div align="center" class="style3"><strong>Price</strong></div></td>
    </tr>
  ...
  ?>
    <tr>
      ...
      <td><div align="center" class="style3"><?php echo $kolom[3];?></div></td>
	  <?php }?>
    </tr>
  </table>
</div>
