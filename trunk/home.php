...
<html lang="en">
  <head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="static/docs/assets/ico/apple-touch-icon-144-precomposed.png">
  ...
  <body>
    ...
    <div class="container navbar-wrapper">
      ...
      <div class="navbar navbar-inverse">
        <div class="navbar-inner">
          ...
          <a class="brand" href="#">E-UMKMS</a>
          <!-- Responsive Navbar Part 2: Place all navbar contents you want collapsed withing .navbar-collapse.collapse. -->
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li class="active"><a href="#">Home</a></li>
              <li><a href="#about">Profil UMKM</a></li>
    ...
    <div class="container marketing">
      ...
      <div class="featurette">
        <img class="featurette-image pull-left" src="static/docs/assets/img/examples/browser-icon-firefox.png">
      ...
      <div class="featurette">
        <img class="featurette-image pull-right" src="static/docs/assets/img/examples/browser-icon-safari.png">
